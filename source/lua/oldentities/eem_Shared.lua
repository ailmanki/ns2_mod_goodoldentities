...
Script.Load("lua/oldentities/Player_modded.lua")
...
--  New classes
Script.Load("lua/oldentities/TeleportTrigger.lua")
Script.Load("lua/oldentities/GravityTrigger.lua")
...
Script.Load("lua/oldentities/PushTrigger.lua")
Script.Load("lua/oldentities/LogicTimer.lua")
Script.Load("lua/oldentities/LogicMultiplier.lua")
...
Script.Load("lua/oldentities/LogicTrigger.lua")
--Script.Load("lua/ExtraEntitiesMod/LogicLua.lua")
Script.Load("lua/oldentities/LogicEmitter.lua")
